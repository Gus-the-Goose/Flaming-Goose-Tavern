...
- **Font family** — includes OpenDyslexic and Atkinson Hyperlegible (designed for readability)
- **High contrast** — maximises contrast for visibility
...
- Death saves
- Spellcasting basics
- All conditions (blinded, charmed, etc.)
- Resting

### 📋 Campaign & characters
Tap the clipboard icon to see character cards and campaign notes (current scene, NPCs, quests, inventory).

### 💬 Send messages
Use the text box at the bottom to address the whole table or a specific character.

## Tips
- **Works best on phone** but fine on tablet or desktop too
- **Your settings are yours** — each person's device remembers its own preferences
- **This is a prototype** — things will improve. Tell us what's broken, what's missing, and what you love.

## Feedback
Tell Anna (or drop a message in the chat). Everything is changeable. This is *your* table.
