...
function clearLiveLogOnce(state) {
  state.meta = state.meta || {};
  if (state.meta.liveLogClearedAt) return false;
  state.log = [];
  state.meta.liveLogClearedAt = "2026-05-11T01:40:00.000Z";
  return true;
}
...
function ensureStateShape(state) {
  ...
  changed = clearLiveLogOnce(state) || changed;
